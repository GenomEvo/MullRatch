...
fitness.vector <- function(pop,        # Vector containing count of mutations each individual carries
                           beta = -4,  # beta parameterises epistasis
                              ...
                              kmax       = 5000) 
{
  ...
  # Each individual in the population is characterized by the number of deleterious mutations that
